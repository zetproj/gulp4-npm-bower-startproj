...
const { src, dest, watch, series, parallel } = require ('gulp'),        // Gulp
			...
			mainBowerFiles             = require ('main-bower-files'),        // Searching and using main bower files
...
function mainBowerCss () {
	return src(mainBowerFiles('**/*.min.css'))
		.pipe (dest (path.source + '/css'))
}

function mainBowerJs () {
	return src(mainBowerFiles('**/*.min.js'))
		.pipe (dest (path.source + '/js'))
}

exports.bowerCss = mainBowerCss
exports.bowerJs = mainBowerJs
